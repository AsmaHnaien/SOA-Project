...
public class ProductClient {
	private static String baseURI ="http://localhost:8070/MyWebsite/rest/products";
	...
	static void testUpdate() {
		WebTarget target=getWebTarget();
		String productId="1";
		Product product=new Product("iPhone X",750.40f);
	...
	static void testAdd() {
		WebTarget target=getWebTarget();
		Product product=new Product("ZenFoneX",800.40f);
